...
tokens = [
    ...
    'LBRACE', 'LBRACKET', 'LEFT_ASSIGN', 'LEQ', 'LPAREN', 'LSHIFT', 'LT',
    'MINUS', 'MODULUS', 'MODULUS_ASSIGN', 'MULTIPLY_ASSIGN', 'NEQ', 'NUMBER',
    'OPEN_BRACE', 'OR_ASSIGN', 'PERIOD', 'RBRACE', 'RBRACKET', 'RIGHT_ASSIGN',
    'RPAREN', 'RSHIFT', 'SEMICOLON', 'STAR', 'STRING_CONSTANT',
    'SUBTRACT_ASSIGN', 'TERNARY', 'XOR_ASSIGN',
